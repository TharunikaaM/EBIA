...
function App() {
  ...
  const [mode, setMode] = useState('evaluate'); // 'evaluate' or 'generate'
    ...
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        <div className="nav-menu">
          <button className="nav-item active"><MessageSquare size={18} /> New Evaluation</button>
          <button className="nav-item"><History size={18} /> History</button>
